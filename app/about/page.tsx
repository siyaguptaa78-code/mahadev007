        ...
        <Reveal>
          <div className="text-center mb-16">
            ...
            <p className="text-zinc-400 text-sm max-w-xl mx-auto font-light">
              India's most trusted online playing exchange insight and prediction gateway.
            </p>
          ...
          <Reveal xOffset={-40}>
            <div className="space-y-6">
              ...
              <p className="text-zinc-300 leading-relaxed font-light">
                Mahadev Book was founded with a clear mission: to create India's most secure, transparent, and rewarding online playing experience. Since 2018, we have grown to serve over 1.2 million verified users across India.
              </p>
