...
const appFeatures = [
  { title: "Live Playing Exchange", desc: "Play on cricket, football, tennis and kabaddi while the action unfolds in real-time." },
...
export default function PlayingAppPage() {
        ...
        <Reveal>
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl md:text-5xl font-serif font-black text-white mb-4">
              Mahadev Book <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-amber-500">Playing App</span>
            </h1>
          ...
          <Reveal xOffset={-45}>
            <div className="space-y-6">
              <h2 className="text-2xl font-serif font-bold text-white leading-snug">
                Download the Mahadev Playing App – India's Most Trusted Mobile Playing Exchange
              </h2>
              <p className="text-zinc-350 leading-relaxed font-light">
                Looking for a secure and lightning-fast online playing app? The official Mahadev Book mobile application brings live markets, expert prediction models, and seamless deposits to your fingertips.
              </p>
