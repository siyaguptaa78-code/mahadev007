      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Reveal>
          <div className="text-center mb-16">
            ...
            <p className="text-zinc-400 text-sm max-w-xl mx-auto font-light">
              Stay ahead with our latest playing guides, legal compliance updates, and match analytics.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {blogPosts.map((post, idx) => {
            const postLink = post.slug === 'premier-league-table' ? '/premier-league-table/' : `/blog/${post.slug}`;
            return (
